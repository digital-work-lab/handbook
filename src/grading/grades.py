...
assert "bonus" == input("Type bonus to confirm that all exams are passed without the bonus points.")
...
cat_dtype = CategoricalDtype(
    categories=["1.0", "1.3", "1.7", "2.0", "2.3", "2.7", "3.0", "3.3", "3.7", "4.0", "4.3", "4.7", "5.0"], ordered=True)
