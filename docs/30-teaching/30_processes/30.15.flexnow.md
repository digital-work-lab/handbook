...
>
> For ERASMUS students, the FlexNow team has to assign students to modules (e-mail request should contain the module title from FlexNow/Modulmanagement/Module).
