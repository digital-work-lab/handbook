...
The thesis advisor (professor) grades the thesis based on the [template](https://github.com/digital-work-lab/handbook/tree/main/src/thesis_review){: target="_blank"} and the predefined [criteria](https://github.com/openjournals/joss-reviews/issues/6318){: target="_blank"}.
