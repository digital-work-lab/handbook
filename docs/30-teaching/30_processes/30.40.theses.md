...
{: .highlight } This page primarily contains **administration details**. For students, information is available on a [separate page](https://digital-work-lab.github.io/theses/){: target="_blank"}.
