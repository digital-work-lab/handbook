...
- Also check for content generated by AI: <!-- generative AI: cannot be detected reliably -->
    ...
    - [EduWriter AI Content Detector](https://eduwriter.ai/ai-content-detector) — free version for teachers & students; paste/upload text to get % AI ‐ likelihood. ([Eduwriter.ai][2])
    - [QuillBot AI Detector](https://quillbot.com/ai-content-detector) — free version; supports multiple languages. ([QuillBot][3])
    - [Grammarly AI Detector](https://www.grammarly.com/ai-detector) — free tool to check if parts of a text look AI-generated. ([Grammarly][4])
    - [SurgeGraph AI Detector](https://surgegraph.io/ai-detector) — free version; sentence-level tagging. ([surgegraph.io][5])
    - [GPTZero](https://gptzero.me/) — free basic usage; paste in text / upload to get AI content score. ([GPTZero][6])
