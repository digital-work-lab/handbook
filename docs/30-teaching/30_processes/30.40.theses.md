...
- Enters the details in the [theses overview](https://github.com/digital-work-lab/theses-confidential/tree/main/theses){: target="_blank"}.
- Enters the **topic** of the thesis and **date** of topic issue in the Word document (the date of topic issue cannot be before the date of enrollment in the Word document; if the Word document cannot be found in the E-Mail history, students can share it):
