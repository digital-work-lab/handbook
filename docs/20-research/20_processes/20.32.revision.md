...
{: .highlight }
The revision sheet generator should be integrated into labot. Revisions should be completed in a list format (responses in Markdown blockquotes) and converted to a table afterwards. Revisions should be completed in branches
...
### 1. Study the review package
   ...
   - **Create a Revision Sheet**: For teams collaborating in Markdown, a structured markdown document with quotes is recommended, for teams collaborating in Word, a Word table is recommended.
