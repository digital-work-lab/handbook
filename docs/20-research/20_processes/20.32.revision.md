...
## Summary Guideline for the Review Process
...
#### 3. Formulate a Revision Strategy
   ...
   - **Draft a revision table**: Crate a revision table (using the [revision sheet generator](https://github.com/geritwagner/revision-sheet-generator)). Note which issues are connected, how and in which order they will be addressed, and by whom.
...
|----------------------------------------------|-----------------------------------------------------------------------------|
| Motivation not persuasive enough             | Enhanced the introduction to better highlight the research gap and significance. |
| Theorization lacks depth                     | Incorporated additional theories and clarified the theoretical framework.    |
| Research design needs more detail            | Expanded the methodology section to include more details on the research design. |
| Analysis requires robustness checks          | Conducted additional robustness checks and included the results in the appendix. |
| Contribution to literature not clear         | Added a section explicitly detailing the contributions to existing literature. |
| Writing quality needs improvement            | Revised the manuscript for clarity, coherence, and readability.              |
| Figures are unclear                          | Redrew all figures to improve clarity and readability.                       |
| Missing recent literature                    | Updated the literature review to include recent studies from the past three years. |

By following these steps and principles, authors can improve their chances of successfully navigating the review process and achieving publication in top-tier journals.

## Tools

- [Revision sheet generator](https://github.com/geritwagner/revision-sheet-generator) to create a revision table.
...
By using these phrases, you can effectively communicate your revisions and demonstrate your appreciation for the reviewers' feedback, ultimately increasing the chances of your manuscript's acceptance.

## Resources

Pang, M. S., & Thatcher, J. B. (2023). A Practical Guide for Successful Revisions and Engagements with Reviewers. *Journal of the Association for Information Systems*, 24(2), 317-327. [link](https://aisel.aisnet.org/jais/vol24/iss2/11/)

Rai, A. (2019). Editor's Comments: the first revision. *MIS Quarterly*, 43(3), iii-viii. [link](https://aisel.aisnet.org/misq/vol43/iss3/2/)
