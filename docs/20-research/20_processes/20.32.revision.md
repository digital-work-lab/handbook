...
>
> After completing the revision sheet in Markdown, it can be transformed into a Word document (revision table) based on the [revision-sheet.py](../../src/revision_sheet.py) script.
