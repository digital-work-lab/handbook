...
{: .highlight }
The revision sheet generator should be integrated into labot. Revisions should be completed in a list format and converted to a table afterwards. Revisions should be completed in branches
...
- [Revision sheet generator](https://github.com/geritwagner/revision-sheet-generator){: target="_blank"} to create a revision table.
