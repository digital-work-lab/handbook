...
For further guidance, see the Science Europe guide on [Research Data Management](https://scienceeurope.org/our-priorities/research-data/research-data-managemen).
...
4. **Data Sharing and Accessibility**
   ...
   **Resources:**
   ...
   - [Create Anonymous/View-Only Links for Peer Review](https://help.osf.io/article/201-create-a-view-only-link-for-a-project)
