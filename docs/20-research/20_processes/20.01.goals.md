...
| DecProcEx | - | [dec-proc-ex](https://github.com/geritwagner/dec-proc-ex-colrev){: target="_blank"} | Data collection completed |
...
| LRSearch | - | [lr-search](https://github.com/geritwagner/lr-search-manuscript){: target="_blank"} | Preparing submission |
