...
## 8. Transmission to the examination office (Thesis advisor, professor)
...
## 9. Thesis writing and feedback sessions (Student, thesis advisor)
...
## 12. Grading (Thesis advisor, professor)

The thesis advisor and professor write a review based on the [template](https://github.com/digital-work-lab/handbook/tree/main/src/thesis_review) and grades the thesis.
...
## 13. Feedback session (Thesis advisor, student)
