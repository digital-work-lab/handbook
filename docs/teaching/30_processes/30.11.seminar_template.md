...
- Have the seminar added to the [VC overview](https://vc.uni-bamberg.de/course/view.php?id=24052){: target="_blank"} (?)
...
- [ ] Professor: The seminar should be announced in the [Fachschaft WIAI newsletter](https://vc.uni-bamberg.de/course/view.php?id=284){: target="_blank"}
