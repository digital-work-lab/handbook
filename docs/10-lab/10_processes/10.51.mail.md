...
<div style="overflow: hidden;">
  <ul style="margin: 0;">
    <li>Only mandatory documents are archived in paper form.
    <li>They receive a unique ID XXXXXX (Paginierstempel)
    <li>Scanned and added to [19.XXXXXX](https://nc-2272638881871040784.nextcloud-ionos.com/index.php/apps/files/?dir=/10-lab/19_archive&fileid=62){: target="_blank"}.
  </ul>

  <img src="{{ site.baseurl }}/assets/images/Screenshot_Stamp.jpg"
       style="float: right; width: 100px; margin-left: 30px;">
</div>
