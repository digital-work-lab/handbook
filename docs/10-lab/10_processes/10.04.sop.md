...
Collaborating in these repositories has many benefits: repositories provide context (clearly identifying the project, its history, and open issues), allow us to reduce direct messages, and use scripts like Labot for automation.
