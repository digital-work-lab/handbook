...
The onboarding issue is based on [this](https://github.com/digital-work-lab/labot/blob/main/labot/templates/onboarding_checklist.md.j2){: target="_blank"} template.
