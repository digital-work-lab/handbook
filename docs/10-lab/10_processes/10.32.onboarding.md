...
Together with the other handbook pages, this **onboarding page** will help you get started smoothly in your new position.
...
{: info }
TODO : roll-on issue (with timeline) + agenda repository
