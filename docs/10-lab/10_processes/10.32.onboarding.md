...
> **TODO**
> 
> - create issue template (request to join team with github-id: ...., tag geritwagner) and labot command (issue trigger): roll-on issue (with timeline) + create agenda repository (with student github-id, initially giving access to the student, stella, and gw)
