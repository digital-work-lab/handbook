...
6. First take some time to find your way around your office and switch on your computer: 
	...
	- [ ] Create a [GitHub account](https://github.com/join){: target="_blank"} and update your availabilities in the [org]({{ site.baseurl }}/docs/01.team.html){: target="_blank"} page.
