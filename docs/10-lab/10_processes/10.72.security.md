...
- Software: [Back-in-time](https://github.com/bit-team/backintime) for Linux
...
- Use a password manager (such as [KeePass](https://keepass.info/))
...
- Be aware of [phising and social engineering attacks](https://www.bsi.bund.de/EN/Themen/Verbraucherinnen-und-Verbraucher/Cyber-Sicherheitslage/Methoden-der-Cyber-Kriminalitaet/Social-Engineering/social-engineering_node.html)
...
- [Digital Self Defense](https://defendourmovements.org/5-tips-for-online-self-defense/)
- [Ratgeber, Digitale Gesellschaft](https://www.digitale-gesellschaft.ch/ratgeber/en/)
